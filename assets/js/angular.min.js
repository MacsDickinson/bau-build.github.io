...
(function(T, ba, p) {
    ...
    function cb(b, a) {
        if (a)
            for (var a = !a.nodeName && u(a.length) && !oa(a) ? a : [a], c = 0; c < a.length; c++) b.push(a[c])
    }
    ...
    function wc(b, a, c, d) {
        ...
        f.cookies = function(a, b) {
            var d, e, f, g;
            if (a)
                if (b === p) h.cookie = escape(a) + "=;path=" + N + ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
                else {
        ...
        this.$get = function() {
            function b(b,
                ...
                var i = 0,
                    ...
                    h = {}, k = d && d.capacity || Number.MAX_VALUE,
                    j = {}, l = null,
                    n = null;
                return a[b] = {
                    put: function(a, b) {
            ...
            function(b, h, k, j, l, n, r, o) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            for (var o = 0, l = k && k.length; o < l; o++)
                                if (h = k[o], h.specified) n = h.name, j = fa(n.toLowerCase()), g[j] = n, c[j] = h = Q($ && n == "href" ? decodeURIComponent(a.getAttribute(n, 2)) : h.value), zb(a, j) && (c[j] = !0), W(a, b, h, j), z(b, j, "A", f);
                            a = a.className;
                            if (F(a))
                                for (; k = e.exec(a);) j = fa(k[2]), z(b, j, "C", f) && (c[j] = Q(k[3])), a = a.substr(k.index + k[0].length);
                            break;
                        case 3:
                            H(b, a.nodeValue);
                            break;
                ...
                function B(a, b, c, d, e) {
                    ...
                    for (var o = -Number.MAX_VALUE, l = [], aa = [], v = null, B = null, z = null, s = c.$$element = y(b), C, H, W, D, t = d, u, x, X, E = 0, G = a.length; E < G; E++) {
                        ...
                        if (C.templateUrl) N("template", z, C, s), z = C, j = V(a.splice(E, a.length - E), j, s, c, e, C.replace, t), G = a.length;
        ...
        function k() {
            for (var a = "", c = o; o < b.length;) {
                ...
                if (g == "." || e(g)) a += g;
                    ...
                    else if (f(g) && (!k || !e(k)) && a.charAt(a.length - 1) == "e") h("Invalid exponent");
                    else break
                }
                o++
            }
    ...
    function Mc(b, a, c, d) {
        ...
        function l() {
            for (var a = [];;)
                if (N.length > 0 && !i("}", ")", ";", "]") && a.push(t()), !f(";")) return a.length == 1 ? a[0] : function(b, c) {
                    for (var d,
                            f = 0; f < a.length; f++) {
                        var e = a[f];
                        e && (d = e(b, c))
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache",
            function(a, c, d, e, g, i, f) {
                function h() {
                    var b = k(),
                        h = r.current;
                    if (b && h && b.$route === h.$route && ga(b.pathParams, h.pathParams) && !b.reloadOnSearch && !n) h.params = b.params, U(h.params, d), a.$broadcast("$routeUpdate", h);
                    else if (b ||
                        ...
                        if (b) {
                            ...
                            if (!u(d = b.template))
                                if (u(d = b.templateUrl)) d = i.get(d, {
                                    cache: f
                                }).then(function(a) {
                                    return a.data
                                });
            ...
            function(a, b, c, h, k, j) {
                function l(a) {
                    ...
                    var e = a.transformRequest || d.transformRequest,
                        ...
                        }, g.common, g[E(a.method)], a.headers),
                        e = Pb(a.data, Ob(g), e),
                        h;
    ...
    function Vb(b, a, c, d, e) {
        ...
        if (i.indexOf("e") !== -1) f = i;
            ...
            var i = Math.pow(10, e),
                ...
                l = a.gSize;
            if (i.length >= j + l)
                for (var k = i.length - j, n = 0; n < k; n++)(k - n) % l === 0 && n !== 0 && (f += c), f += i.charAt(n);
    ...
    var lc = /[A-Z]/g,
        ...
        }, Ba = P.cache = {}, Aa = P.expando = "ng-" + (new Date).getTime(),
        pc = 1,
    ...
    var La = {
        ...
        "!": function(a, c, d) {
            ...
            "'": "'",
            '"': '"'
        }, ib = {}, Yc = T.XMLHttpRequest || function() {
            try {
    ...
    var Sa = function(a) {
        ...
        bc = {
            ...
            number: function(a, c, d, e, g, i) {
                ...
                e.$formatters.push(function(a) {
                    return S(a) || wa(a) ? (e.$setValidity("number", !0), a) : (e.$setValidity("number", !1), p)
                })
            },
                            ...
                            function h() {
                                ...
                                for (y = c.length; w < y; w++) {
                                    ...
                                    if (v.length <= w) t = {
                                        ...
                                        label: i.label
                                    }, u = [t], v.push(u), f.append(t.element);
                                    else if (u = v[w], t = u[0], t.label != d) t.element.attr("label", t.label = d);
                                    C = null;
                                    x = 0;
                                    for (z = i.length; x < z; x++)
                                        if (d = i[x], s = u[x + 1]) {
                                            ...
                                            d.selected).text(d.label), u.push({
                                            element: A,
                                            label: d.label,
                                            id: d.id,
                                            selected: d.selected
                                        }), C ? C.after(A) : t.element.append(A), C = A;
